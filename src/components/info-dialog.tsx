...
export const InfoDialog = (): ReactElement => {
  ...
  return (
    <div className="bg-c-darker p-4 fixed bottom-5 left-5 right-5 rounded-md flex gap-4 z-10">
      <p className="text-c-light-gray text-justify max-s-600:text-xs">As informações apresentadas neste site são de caráter informativo e podem não refletir as condições mais atualizadas, pois as instituições financeiras podem alterar benefícios, taxas e requisitos sem aviso prévio.
